...
<body>
    ...
    <table   align="center" style="color: white; width: 100%; border: 5px solid aqua; padding: 50px; ">
...
if (isset($_GET['delete'])) {
    ...
    $deleteQuery = "DELETE FROM asset WHERE id = '$assetId'";
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo "<td><a href='edit_asset.php?id=".$row['id']."' class='edit-button'>Edit</a></td>";
    echo "<td><a href='?delete=".$row['id']."' onclick='return confirmDelete();' class='delete-button'>Delete</a></td>";
    echo "</tr>";
}
?>
